...
const PinIcon = () => (
  <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
    ...
    <path
      d="M16 8c-1.1 0-2 .9-2 2v6l-2 2v1h4v5l1 1 1-1v-5h4v-1l-2-2v-6c0-1.1-.9-2-2-2z"
...
export default function Sidebar() {
  const navItems = [
    ...
    { path: "/digest", label: "Digest", icon: DigestIcon },
    ...
    <aside className="sidebar">
      <div className="sidebar-header">
        <div className="sidebar-logo">
          <PinIcon />
          <span className="sidebar-title">PINS</span>
        </div>
      </div>
